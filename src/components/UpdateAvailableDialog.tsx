...
const GITHUB_RELEASES_URL = 'https://github.com/ganbo-gab/open-storyboard-canvas/releases/latest';
    ...
    <UiModal
      ...
      footer={(
        <>
          ...
          <UiButton variant="primary" onClick={handleOpenGithub} disabled={!GITHUB_RELEASES_URL}>
